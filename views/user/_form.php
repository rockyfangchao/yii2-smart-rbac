...
$userRoles = \smart\rbac\models\UserRoleRelation::find()->select('role_id')->where(['user_id' => $model->id])->column();
...
<div class="user-form">
    ...
    <?= $form->field($model, 'role_ids')->label('角色')->checkboxList(\smart\rbac\models\Role::getRoleNameArray(),['value'=>$model->role_ids])?>
